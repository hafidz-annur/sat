                    ...
                    <div class="col-md">
                        <div class="card shadow mb-5">
                            <div class="card-header text-center">
                                <h4>Section 3 <br> Non Calculator Test</h4>
                            </div>
                            <div class="card-body p-0 ">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <div>
                                        <td><input type="radio" name="<?='nc'.$i;?>" value="A">
                                        </td>
                                        <td><input type="radio" name="<?='nc'.$i;?>" value="B">
                                        </td>
                                        <td><input type="radio" name="<?='nc'.$i;?>" value="C">
                                        </td>
                                        <td><input type="radio" name="<?='nc'.$i;?>" value="D">
                                        </td>
                                        </div>
                                    </tr>
                                    <?php } 
                                    ...
                                    for($i=15;$i<20;$i++){ ?>
                                        <tr>
                                            <td><small><?=$i+1;?></small></td>
                                            <td>
                                                <select class="form-control-sm" name="oa<?=$i;?>" id="">
                                            ...
                                            <td>
                                                <select class="form-control-sm" name="ob<?=$i;?>" id="">
                                            ...
                                            <td>
                                                <select class="form-control-sm" name="oc<?=$i;?>" id="">
                                            ...
                                            <td>
                                                <select class="form-control-sm" name="od<?=$i;?>" id="">
...
var countDownDate = (now_basic + 25.4 * 60) * 1000;
