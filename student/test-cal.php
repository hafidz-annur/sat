                    ...
                    <div class="col-md">
                        <div class="card shadow mb-5">
                            <div class="card-header text-center">
                                <h4>Section 4 <br> Calculator Test</h4>
                            </div>
                            <div class="card-body p-0 ">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <div>
                                        <td><input type="radio" name="<?='c'.$i;?>" value="A">
                                        </td>
                                        <td><input type="radio" name="<?='c'.$i;?>" value="B">
                                        </td>
                                        <td><input type="radio" name="<?='c'.$i;?>" value="C">
                                        </td>
                                        <td><input type="radio" name="<?='c'.$i;?>" value="D">
                                        </td>
                                        </div>
                                    </tr>
                                    <?php } 
...
var countDownDate = (now_basic + 55.5 * 60) * 1000;
