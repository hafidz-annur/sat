        ...
        <form action="test-reading.php" method="post" onsubmit="return confirm('Do you want to start the test ?');">
            <table name="student">
                ...
                <td width="90%">
                    ...
                    <label for="inputname"><h4> Welcome <?=$name?> , Choose your question type</h4></label>
                    <p><small><i> *P.S. When you enter start, the time will starts to count down</i></small></p>
                    <select class="form-control mt-2" name="tipetest" id="tipetest" required>
                    <?php 
                ...
                <input type="hidden" name="waktu_mulai" value="<?=time()?>">
                <td width="10%" class="align-middle">
                <input class="btn btn-dark btn-block mt-5" width="100" type="submit" name="idtest" value="Start" id='search' ></td>
            </tr>
            </table>
        </form>
    </div>
